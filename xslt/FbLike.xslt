...
<xsl:template match="/">
	...
	<xsl:variable name="level" select="'1 2'" />
	 
	<xsl:if test="$currentPage[not(contains($level,@level))]">
		<div class="social-plugins">
			<div class="fb-like" data-send="true" data-layout="button_count" data-width="288" data-show-faces="true" data-font="segoe ui">&nbsp;</div>
		</div>
	</xsl:if>
